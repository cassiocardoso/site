  ...
  return (
    <PageLayout title="Uses">
      ...
      <p>
        ...
        been using regularly since 2016. I don&apos;t add a bunch of plugins to Webstorm since I
        think the bundled ones are pretty good, but I always install the{' '}
      ...
      <h2>Terminal</h2>
      <p>
        For terminal I am using <a href="https://hyper.is/">Hyper</a>, after many years with iTerm2.
        I use the Nord theme and a few plugins:{' '}
      ...
      <p>
        ...
        been a huge fan of <a href="https://draculatheme.com/">Dracula</a> and I occasionally switch
        between them.
      </p>
      <p>
        My font of choice is <a href="https://gumroad.com/l/dank-mono">Dank Mono</a>, which I bought
        a few years ago. It has very good ligatures and is pleasant to look at. Recently I have been
      ...
      <p>
        ...
        used Dropbox for a long time, but sharing stuff between 2 accounts became harder and costly.
        So far I have no complains about OneDrive and the family plan works well.
      </p>
      <h2>Desk Setup</h2>
      <p>
